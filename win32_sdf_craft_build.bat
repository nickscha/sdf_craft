...
set PLATFORM_NAME=win32_sdf_craft
set ICON_DATA=win32_sdf_craft.res
...
cc -s -Oz %DEF_COMPILER_FLAGS% %PLATFORM_NAME%.c %ICON_DATA% -o %PLATFORM_NAME%.exe %DEF_FLAGS_LINKER%
%PLATFORM_NAME%.exe
